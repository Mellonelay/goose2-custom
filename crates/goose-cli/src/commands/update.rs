#[cfg(all(feature = "update", not(feature = "disable-update")))]
use anyhow::Context;
...
pub async fn update(canary: bool, reconfigure: bool) -> Result<()> {
    #[cfg(not(all(feature = "update", not(feature = "disable-update"))))]
    {
...
#[cfg(all(test, feature = "update", not(feature = "disable-update")))]
mod tests {
    use super::*;
